...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "palekarsumit0679@gmail",
    href: "mailto:palekarsumit0679@gmail.com",
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/sumit-palekar-8a9123280",
    content: "/Sumit-Palekar",
    icon: <FaLinkedin height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/Sumitpalekar",
    content: "/Sumitpalekar",
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">Sumit Palekar</p>
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m Sumit, a BlockChain developer passionate about
              creating meaningful Dapps. With great in Web
